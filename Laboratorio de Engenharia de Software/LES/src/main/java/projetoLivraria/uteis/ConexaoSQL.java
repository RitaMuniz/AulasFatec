...
public class ConexaoSQL {
    ...
    String URL = "jdbc:sqlite:" + raizProjeto.resolve("livraria.db");

    private static ConexaoSQL instance;

    private ConexaoSQL() throws URISyntaxException {
        try {
    ...
    public static ConexaoSQL getInstance() throws URISyntaxException {
