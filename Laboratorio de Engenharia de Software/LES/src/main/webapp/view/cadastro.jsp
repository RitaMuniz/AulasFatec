...
<div class="container" style="max-width:600px; margin:40px auto;">
    ...
    <div class="form-box">
        ...
        <!--
            action="/cliente" aponta para o @WebServlet(urlPatterns = {"/cliente"})
        ...
        <form action="${pageContext.request.contextPath}/cliente" method="post">
            ...
            <h3 style="margin-bottom:16px;">Endereço Principal</h3>

            <label for="tipoEndereco">Tipo de Endereço</label>
            <select id="tipoEndereco" name="tipoEndereco" required style="width:100%; padding:12px; margin-bottom:15px; border:1px solid #ccc; border-radius:6px;">
