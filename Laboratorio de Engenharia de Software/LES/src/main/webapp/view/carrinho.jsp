    ...
    <c:choose>
        ...
        <c:otherwise>
            ...
            <div class="card" style="text-align:right; max-width:350px; margin-left:auto;">
                ...
                <p>Frete: <strong data-test="valor-frete">R$ 20,00</strong></p>
                <hr style="margin:10px 0;">
                <p style="font-size:18px;">Total estimado: <strong data-test="total-estimado">R$ <fmt:formatNumber value="${sessionScope.carrinho.subtotal + 20}" minFractionDigits="2" maxFractionDigits="2"/></strong></p>
