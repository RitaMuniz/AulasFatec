...
describe('Fluxo Contínuo - Ciclo de Vida da Troca', () => {
    ...
    it('Deve acompanhar o ciclo completo: Cliente solicita -> Admin aprova, recebe, conclui -> Cliente valida cupom', () => {
        ...
        adminTrocas.clicarBotao('aprovar', trocaInicial.id)
        adminTrocas.validarMensagem('aprovada')

        adminTrocas.clicarBotao('receber', trocaInicial.id)
        adminTrocas.validarMensagem('sucesso')

        adminTrocas.clicarBotao('concluir', trocaInicial.id)
        ...
        const trocaFinalizada = {
            ...
            dataSolicitacao: '2026-06-11',
            status: 'CONCLUIDA',
            dataRecebimento: '2026-06', // Assumindo que o sistema preencha com a data atual
            cupomGerado: '✅ Cupom #25' // Procura parcialmente pela geração do cupom na linha do ID 2
